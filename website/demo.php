<?php $titre ="Demo"; include("include/header.php");?>
            ...
            <div class="article">
                    <div class="header">
                        ...
                        <p>Text header : Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam sodales urna non odio egestas tempor. Nunc vel vehicula ante. Etiam bibendum iaculis libero, eget molestie nisl pharetra in. In semper consequat est, eu porta velit mollis nec.</p>
                    </div>
                        <h2>Features :</h2>
                        <h3 class="separate">Navigation Bar</h3>
                        ...
                        <h3 class="separate">Bash console</h3>
                        <div class="console">
                        ...
                        <h3 class="separate">Card message</h3>
                        ...
                        <div class="progress">
                          <div class="bar bar-red" style="width: 90%;"></div>
                            ...
                            <h3 class="separate">Highlight paragraph</h3>
                            ...
                            tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
                            <h3 class="separate">Blockquote</h3>
                            ...
                            <h3 class="separate">Hint on hover</h3>  
                            ...
                            <h3 class="separate">Scrabble</h3>

                           <span class="scrabble">Lorem</span>

                           <h3 class="separate">Pop-up</h3>     
                           ...
                           <div id="popup5" class="popup red">
                            ...
                            <h3 class="separate">Price-List</h3>
